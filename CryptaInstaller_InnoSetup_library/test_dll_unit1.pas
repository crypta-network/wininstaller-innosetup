{
 Easy way to quick test CryptaInstaller_InnoSetup_library.dll
}
...
function fIsPortAvailable(sIpAddress: ansistring; wPort: word): boolean; stdcall;
  external 'CryptaInstaller_InnoSetup_library.dll';
function fMemoryTotalPhys(var MemTotalPhysMB: integer): boolean; stdcall; external 'CryptaInstaller_InnoSetup_library.dll';
